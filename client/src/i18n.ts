...
const resources = {
  en: {
    translation: {
      ...
      dashboard_3d_title: '3D',
      dashboard_3d_locked_subtitle: '3D view not available yet',
      dashboard_3d_subtitle_admin: 'Manage 3D scenes & hotspots',
      dashboard_3d_subtitle_customer: 'Explore your project in 3D',
      ...
      admin_dashboard_3d_label: '3D',
      admin_dashboard_3d_helper: 'Global 3D scenes & hotspots',

      admin_3d_projects_title: 'Projects & 3D',
      admin_3d_projects_subtitle: 'Assign customers and unlock 3D view per project.',
      admin_3d_unlock_label: 'Unlock 3D',
      admin_3d_scenes_link: 'Scenes',
      admin_3d_back: 'Projects',
      admin_3d_title: '3D',
      admin_3d_scenes_title_suffix: 'Scenes & Hotspots',
      admin_3d_upload_title: 'Upload scene',
      admin_3d_upload_images_label: '360° JPG',
      admin_3d_upload_help: 'Upload a 360° JPG and then edit hotspots to navigate between rooms.',
      admin_3d_scenes_list_title: 'Scenes',
      admin_3d_scenes_empty: 'No 3D scenes yet. Upload your first 360° image above.',
      admin_3d_select_scene_hint: 'Select a scene to edit its hotspots.',
      admin_3d_delete_scene_confirm: 'Delete scene "{{name}}"?',

      customer_3d_empty: 'No 3D scenes yet.',
      ...
      factor_table_item: 'Item',
      factor_table_item_placeholder: 'Item name',
      factor_table_quantity: 'Qty',
      factor_table_unit: 'Unit',
      factor_table_unit_price: 'Unit price',
      factor_table_amount: 'Total (DA)',
      factor_unit_unit: 'Unit',
      factor_unit_m: 'm',
      factor_unit_m2: 'm²',
      ...
      invoice_settings_subtitle: 'Customize company name, logo, and footer shown on printed invoices.',
      invoice_settings_company_logo: 'Company Logo',
      invoice_settings_upload_logo: 'Upload Logo',
      invoice_settings_remove_logo: 'Remove Logo',
      invoice_settings_company_info: 'Company Information',
      invoice_settings_company_name: 'Company Name',
      invoice_settings_address: 'Address',
      invoice_settings_phone: 'Phone',
      invoice_settings_email: 'Email',
      invoice_settings_website: 'Website',
      invoice_settings_currency: 'Currency',
      invoice_settings_currency_dzd: 'DZD - Algerian Dinar',
      invoice_settings_currency_da: 'DA - Algerian Dinar',
      invoice_settings_currency_usd: 'USD - US Dollar',
      invoice_settings_currency_eur: 'EUR - Euro',
      invoice_settings_logo_url: 'Logo URL',
      invoice_settings_logo_preview: 'Preview',
      invoice_settings_footer: 'Footer text',
      invoice_settings_save_company_info: 'Save Company Info',
  ...
  fr: {
    translation: {
      ...
      dashboard_3d_title: '3D',
      dashboard_3d_locked_subtitle: 'Vue 3D pas encore disponible',
      dashboard_3d_subtitle_admin: 'Gérer les scènes 3D',
      dashboard_3d_subtitle_customer: 'Explorer votre projet en 3D',
      dashboard_contact_us: 'Nous contacter',
      ...
      admin_dashboard_3d_label: '3D',
      admin_dashboard_3d_helper: 'Scènes 3D globales et hotspots',

      admin_3d_projects_title: 'Projets & 3D',
      admin_3d_projects_subtitle: 'Assignez des clients et débloquez la vue 3D par projet.',
      admin_3d_unlock_label: 'Débloquer 3D',
      admin_3d_scenes_link: 'Scènes',
      admin_3d_back: 'Projets',
      admin_3d_title: '3D',
      admin_3d_scenes_title_suffix: 'Scènes & Hotspots',
      admin_3d_upload_title: 'Téléverser une scène',
      admin_3d_upload_images_label: 'JPG 360°',
      admin_3d_upload_help: 'Téléversez un JPG 360° puis modifiez les hotspots pour naviguer entre les pièces.',
      admin_3d_scenes_list_title: 'Scènes',
      admin_3d_scenes_empty: 'Aucune scène 3D pour le moment. Téléversez votre première image 360° ci-dessus.',
      admin_3d_select_scene_hint: 'Sélectionnez une scène pour modifier ses hotspots.',
      admin_3d_delete_scene_confirm: 'Supprimer la scène "{{name}}" ?',

      customer_3d_empty: 'Aucune scène 3D pour le moment.',
      ...
      factor_table_date: 'Date',
      factor_table_description: 'Description',
      factor_table_item: 'Article',
      factor_table_item_placeholder: 'Nom de l\'article',
      factor_table_quantity: 'Qté',
      factor_table_unit: 'Unité',
      factor_table_unit_price: 'Prix unitaire',
      factor_table_amount: 'Total (DA)',
      factor_unit_unit: 'Unité',
      factor_unit_m: 'm',
      factor_unit_m2: 'm²',
      ...
      invoice_settings_title: 'Paramètres de facture',
      invoice_settings_subtitle: 'Personnalisez le nom, le logo et le pied de page des factures imprimées.',
      invoice_settings_company_logo: 'Logo de l\'entreprise',
      invoice_settings_upload_logo: 'Télécharger le logo',
      invoice_settings_remove_logo: 'Supprimer le logo',
      invoice_settings_company_info: 'Informations de l\'entreprise',
      invoice_settings_company_name: 'Nom de l\'entreprise',
      invoice_settings_address: 'Adresse',
      invoice_settings_phone: 'Téléphone',
      invoice_settings_email: 'E-mail',
      invoice_settings_website: 'Site web',
      invoice_settings_currency: 'Devise',
      invoice_settings_currency_dzd: 'DZD - Dinar algérien',
      invoice_settings_currency_da: 'DA - Dinar algérien',
      invoice_settings_currency_usd: 'USD - Dollar américain',
      invoice_settings_currency_eur: 'EUR - Euro',
      invoice_settings_logo_url: 'URL du logo',
      invoice_settings_logo_preview: 'Aperçu',
      invoice_settings_footer: 'Texte du pied de page',
      invoice_settings_save_company_info: 'Enregistrer les infos entreprise',
  ...
  ar: {
    translation: {
      ...
      dashboard_3d_title: '3D',
      dashboard_3d_locked_subtitle: 'عرض 3D غير مفعّل بعد',
      dashboard_3d_subtitle_admin: 'إدارة مشاهد 3D',
      dashboard_3d_subtitle_customer: 'استكشف مشروعك بتقنية 3D',
      dashboard_contact_us: 'اتصل بنا',
      ...
      admin_dashboard_3d_label: '3D',
      admin_dashboard_3d_helper: 'إدارة مشاهد 3D والنقاط',

      admin_3d_projects_title: 'المشاريع و 3D',
      admin_3d_projects_subtitle: 'قم بتعيين العملاء وفتح عرض 3D لكل مشروع.',
      admin_3d_unlock_label: 'فتح 3D',
      admin_3d_scenes_link: 'المشاهد',
      admin_3d_back: 'المشاريع',
      admin_3d_title: '3D',
      admin_3d_scenes_title_suffix: 'المشاهد و النقاط',
      admin_3d_upload_title: 'رفع مشهد',
      admin_3d_upload_images_label: 'JPG 360°',
      admin_3d_upload_help: 'ارفع صورة 360° ثم عدّل النقاط للتنقّل بين الغرف.',
      admin_3d_scenes_list_title: 'المشاهد',
      admin_3d_scenes_empty: 'لا توجد مشاهد 3D بعد. ارفع أول صورة 360° بالأعلى.',
      admin_3d_select_scene_hint: 'اختر مشهدًا لتعديل النقاط.',
      admin_3d_delete_scene_confirm: 'حذف المشهد "{{name}}"؟',

      customer_3d_empty: 'لا توجد مشاهد 3D بعد.',
      ...
      factor_table_item: 'الاغراض',
      factor_table_item_placeholder: 'اسم الغرض',
      factor_table_quantity: 'الكمية',
      factor_table_unit: 'الوحدة',
      factor_table_unit_price: 'السعر للوحدة',
      factor_table_amount: 'الإجمالي (DA)',
      factor_unit_unit: 'وحدة',
      factor_unit_m: 'م',
      factor_unit_m2: 'م²',
      ...
      invoice_settings_title: 'إعدادات الفاتورة',
      invoice_settings_subtitle: 'تخصيص اسم الشركة والشعار والتابع في الفواتير المطبوعة.',
      invoice_settings_company_logo: 'شعار الشركة',
      invoice_settings_upload_logo: 'رفع الشعار',
      invoice_settings_remove_logo: 'إزالة الشعار',
      invoice_settings_company_info: 'معلومات الشركة',
      invoice_settings_company_name: 'اسم الشركة',
      invoice_settings_address: 'العنوان',
      invoice_settings_phone: 'الهاتف',
      invoice_settings_email: 'البريد الإلكتروني',
      invoice_settings_website: 'الموقع الإلكتروني',
      invoice_settings_currency: 'العملة',
      invoice_settings_currency_dzd: 'DZD - دينار جزائري',
      invoice_settings_currency_da: 'DA - دينار جزائري',
      invoice_settings_currency_usd: 'USD - دولار أمريكي',
      invoice_settings_currency_eur: 'EUR - يورو',
      invoice_settings_logo_url: 'رابط الشعار',
      invoice_settings_logo_preview: 'معاينة',
      invoice_settings_footer: 'نص التابع',
      invoice_settings_save_company_info: 'حفظ معلومات الشركة',
